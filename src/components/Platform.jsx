...
export default function Platform() {
    ...
    return (
            <section
                ref={ref}
                className="relative px-4 overflow-hidden bg-[url('/assets/images/png/platform.png')] bg-center bg-cover bg-no-repeat py-20"
            >
                <div className="max-w-[861.1px] mx-auto text-center">
                    ...
                    <h2 className=" text-3xl sm:text-custom-5xl font-normal text-black mt-2">
