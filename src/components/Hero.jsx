        ...
        <div className='flex flex-col justify-center items-center w-full'>
          ...
          <div className='max-w-[428.1px] shadow-[0px_4px_15px_0px_#07678726] flex flex-row justify-between items-center w-full h-[56.1px] rounded-sm mt-12.25 bg-white mx-4'>
            <input
              ...
              className='ml-2.25 border-0 outline-none focus:outline-none focus:ring-0 placeholder:text-black/70 text-whity text-sm sm:text-base font-medium placeholder:font-medium min-w-0 flex-1'
            />
            <Button
              variants='first'
              text={'Get Started'}
